...
def plus(number): return {'op': '+', 'num': number}


def minus(number): return {'op': '-', 'num': number}


def times(number): return {'op': '*', 'num': number}


def divided_by(number): return {'op': '//', 'num': number}
